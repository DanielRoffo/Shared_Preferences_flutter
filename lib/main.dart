...
import 'package:shared_preferences_flutter/models.dart';
import 'package:shared_preferences_flutter/preferences_service.dart';
        ...
        body: ListView(
          children: [
            ...
            RadioListTile(
                ...
                groupValue: _selectedGender,
                onChanged: (newValue) => setState(() => _selectedGender = newValue!)),
            CheckboxListTile(title: Text('Dart'),
            ...
            CheckboxListTile(title: Text('JavaScript'),
            ...
            CheckboxListTile(title: Text('Kotlin'),
            ...
            CheckboxListTile(title: Text('Swift'),
            ...
            SwitchListTile(title: Text('Is Employed') ,value: _isEmployed, onChanged: (newValue) => setState(() => _isEmployed = newValue)),
